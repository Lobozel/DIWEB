...
$(function() {
	$("#attr").click(function(){
		$(this).text("Hola soy Miguel y mi DNI es 37383937E");
	});
});
...
$(function() {
	$("#attr").mouseover(function() {
		alert("Hola soy el alumno Miguel y mi DNI es 37383937E");
	})
});
 ...
 $(function() {
	$("#addClass").click(function(){
		...
		if($(this).hasClass('example')){
			$(this).removeClass('example').addClass('rojo');
		}else{
			$(this).removeClass('rojo').addClass('example');
		}
	});
 });
